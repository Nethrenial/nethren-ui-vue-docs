import {
  ...
  lib,
  pathBrowserify
} from "./chunk-O24MNAP5.js";
import "./chunk-G3CMYKT2.js";
import {
  __publicField
} from "./chunk-UGBRVHZY.js";

// node_modules/vite-plugin-vue-preview/dist/chunks/index3-8c3354c5-d45df5f5.js
var dist = {};
var main$1 = {};
var registry = {};
var grammar = {};
...
var monaco_textmate_1 = main$1;
var tm_to_monaco_token_1 = tmToMonacoToken;
...
async function dispatchGrammars(scopeName) {
  switch (scopeName) {
    case "source.vue":
      return {
        format: "json",
        content: await import("./vue.tmLanguage-1f8c7b61-1f8c7b61-MGFVFGE3.js")
      };
    case "source.ts":
      return {
        format: "json",
        content: await import("./TypeScript.tmLanguage-01b7ed7f-01b7ed7f-RTSF2MYI.js")
      };
    case "source.js":
      return {
        format: "json",
        content: await import("./JavaScript.tmLanguage-5b3aef1e-5b3aef1e-CLE34IBQ.js")
      };
    case "text.html.basic":
      return {
        format: "json",
        content: await import("./html.tmLanguage-98b80916-98b80916-V4WRN3SE.js")
      };
    case "source.css":
      return {
        format: "json",
        content: await import("./css.tmLanguage-b56789b8-b56789b8-NQLH3GX4.js")
      };
    default:
      return {
        format: "json",
...
//# sourceMappingURL=index3-8c3354c5-d45df5f5-L3YBPXGP.js.map
